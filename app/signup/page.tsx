    ...
    <div className="min-h-screen w-full flex bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500/30 items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-slate-900/50 backdrop-blur-xl border border-slate-800 p-8 sm:p-10 rounded-3xl shadow-[0_0_50px_-12px_rgba(0,0,0,0.5)] z-10 relative">
        ...
        <div className="flex flex-col items-center mb-8 relative z-10">
          <Link href="/">
            <div className="w-12 h-12 mb-4 rounded-xl bg-gradient-to-br from-indigo-500 to-emerald-600 flex items-center justify-center shadow-lg shadow-indigo-500/20 cursor-pointer transform hover:rotate-3 transition-transform">
        ...
        <form action={signUp} className="space-y-5 relative z-10">
          ...
          <button className="w-full h-12 text-base font-bold rounded-xl bg-gradient-to-r from-indigo-600 to-emerald-600 hover:from-indigo-500 hover:to-emerald-500 text-white shadow-[0_0_20px_-5px_rgba(99,102,241,0.4)] transition-all transform hover:-translate-y-0.5 mt-2 flex items-center justify-center gap-2">
            Sign Up <UserPlus className="w-4 h-4" />
          </button>

          {searchParams?.message && (
            <p className={`mt-4 p-4 border text-center text-sm rounded-xl ${
